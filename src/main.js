...
const skillBaseData = {
  ...
  "Redemption Strength": {
    name: "Redemption Strength",
    maxXp: 100,
    effect: 0.01,
    description: "Blessings gain",
  },
  Clairvoyance: {
    name: "Clairvoyance",
    maxXp: 100,
    effect: 0.02,
    description: "Redemption strength xp",
  },
  "Serene focus": {
    name: "Serene focus",
    maxXp: 100,
    effect: 0.03,
    description: "Clairvoyance xp",
  },
  "Photon attraction": {
    name: "Photon attraction",
    maxXp: 100,
    effect: 0.04,
    description: "Serene focus xp",
  },
  "Angelic aura": {
    name: "Angelic aura",
    maxXp: 100,
    effect: 0.05,
    description: "Photon attraction xp",
  },
};
...
function updateTaskRows() {
  for (key in gameData.taskData) {
    ...
    row.getElementsByClassName("xpMultipliers")[0].textContent =
      getTaskMultiplierList(task.xpMultipliers);
    ...
    valueElement.getElementsByClassName("income")[0].style.display =
      task instanceof Job ? "block" : "none";
    valueElement.getElementsByClassName("effect")[0].style.display =
      task instanceof Skill ? "block" : "none";

    if (task instanceof Job) {
      row.getElementsByClassName("incomeMultipliers")[0].textContent =
        getTaskMultiplierList(task.incomeMultipliers);
      formatCoins(
        task.getIncome(),
...
function updateItemRows() {
  for (key in gameData.itemData) {
    ...
    row.getElementsByClassName("expenseMultipliers")[0].textContent =
      getTaskMultiplierList(item.expenseMultipliers);
  }
}
...
gameData.requirements = {
  ...
  "Travelling merchant": new TaskRequirement("Travelling merchant", [
    { task: "Bargaining", requirement: 1000 },
    { task: "Merchant", requirement: 300 },
  ]),
  ...
  //Holy magic
  "Holy influence": new BlessingsRequirement("Holy influence", [
    { requirement: 1 },
  ]),
  "Redemption strength": new BlessingsRequirement("Redemption strength", [
    { requirement: 1 },
  ]),
  Clairvoyance: new BlessingsRequirement("Clairvoyance", [{ requirement: 1 }]),
  "Serene focus": new BlessingsRequirement("Serene focus", [
    { requirement: 25 },
  ]),
  "Photon attraction": new BlessingsRequirement("Photon attraction", [
    { requirement: 75 },
  ]),
  "Angelic aura": new BlessingsRequirement("Angelic aura", [
    { requirement: 150 },
  ]),
  ...
  "Sky fortress": new CoinRequirement("Sky fortress", [
...
gameData.milestones = {
  ...
  Hercules: new Milestone("Strength", 50, {
    task: "Strength",
    requirement: 1000,
  }),
};
